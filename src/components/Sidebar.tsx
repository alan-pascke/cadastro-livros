...
export default function Sidebar(props: sidebarProps){
    ...
    function listCategoria(){
        return(
            <div className={`bg-slate-800 p-[10px_0_10px_20px] transition-transform duration-300`}>
                <ul>
                    <li className="pt-3 pb-3 hover:text-white">Aventura</li>
                    <li className="pt-3 pb-3 hover:text-white">Ação</li>
                    <li className="pt-3 pb-3 hover:text-white">Ficção Científica</li>
                </ul>
            </div>
        )
    }
    ...
    function sidebarContent(style?: string){
        return(
            <div className="absolute top-0">
                ...
                <div className="bg-blue-100 rounded-t-lg overflow-hidden m-28 ml-2 w-[92%] cursor-pointer">
                        <div className="
                        pl-4 pt-4 pb-4 
                        text-xl 
